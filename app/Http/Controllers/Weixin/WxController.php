...
//                echo '<pre>';print_r($url);echo '</pre>';die;
            ...
            if($xml_obj->EventKey=='weather'){
                ...
                //请求第三方接口 获取天气
                $weather_info_api = 'https://free-api.heweather.net/s6/weather/now?location=beijing&key=626278c5cabf4f09835d91daec5c91e0';
                $weatherInfo = file_get_contents($weather_info_api);
                $weather_info_arr = json_decode($weatherInfo,true);
...
//        echo "下载素材成功";echo '</br>';//        echo "文件名: ".$file_name;
    }
    ...
    public function createMenu(){
        ...
        $url2='http://1905liuqingyuan.comcto.com/';
        ...
        $menu = [
            'button'    => [
                ...
                [
                    'type'=>'view',
                    'name'=>'商场',
                    'url' =>'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0079197aeab14faf&redirect_uri='.$redirect_uri2.'&response_type=code&scope=snsapi_userinfo&state=ABCD1905#wechat_redirect'
                ],
            ]
         ];
        ...
        echo $response->getBody();      //接收微信接口响应的数据
    }
